                    ...
                    <td class="px-6 py-4">
                        <div class="flex space-x-2 justify-center">
                            @can('admin.states.edit')
                                <a href="{{ route('admin.states.edit', $state) }}" class="btn btn-secondary text-xs">{{ __('messages.Edit') }}</a>
                            @endcan
                            @can('admin.states.destroy')
                                <form action="{{ route('admin.states.destroy', $state) }}" method="POST" class="delete-form">
                                    @method('DELETE')
                                    @csrf
