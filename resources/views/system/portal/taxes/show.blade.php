<x-layouts.portal>
    ...
    <div  class="mb-8 flex justify-between items-center">
        <flux:breadcrumbs> 
            ...
            <flux:breadcrumbs.item href="{{ route('portal.taxes.index') }}">
                {{ __('messages.Taxes') }}
            </flux:breadcrumbs.item>
            <flux:breadcrumbs.item>
        ...
        <a href="{{ route('portal.taxes.index') }}" class="btn btn-danger">{{ __('messages.Return to list') }}</a>
    </div>
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <div class="mb-8 flex justify-between items-center p-6">
        ...
        <a href="{{ route('portal.taxes.print', $tax) }}" target="_blank" class="btn btn-success">{{ __('messages.Print') }}</a>
    </div>
