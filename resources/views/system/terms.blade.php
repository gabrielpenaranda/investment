    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="flex items-center mb-4 md:mb-0">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Website Terms of Use</p>
                    </div>
                </div>
        ...
        <section class="bg-white rounded-xl shadow-md p-6 mb-8 border border-blue-100">
            ...
            <p class="text-gray-600 mb-4">
                These Terms of Use govern your access to and use of Asset Performance Fund's website. By accessing our website, you agree to be bound by these terms and our Privacy Policy.
            </p>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div class="bg-blue-50 p-4 rounded-lg border border-blue-200 text-center">
                    <i class="fas fa-check-circle text-blue-600 text-xl mb-2"></i>
                    <h3 class="font-semibold text-gray-700">Agreement</h3>
                    <p class="text-sm text-gray-600 mt-1">By using our site you accept these terms</p>
                </div>
                <div class="bg-green-50 p-4 rounded-lg border border-green-200 text-center">
                    <i class="fas fa-ban text-green-600 text-xl mb-2"></i>
                    <h3 class="font-semibold text-gray-700">Restrictions</h3>
                    <p class="text-sm text-gray-600 mt-1">Certain uses are prohibited</p>
                </div>
                <div class="bg-purple-50 p-4 rounded-lg border border-purple-200 text-center">
                    <i class="fas fa-exclamation-triangle text-purple-600 text-xl mb-2"></i>
                    <h3 class="font-semibold text-gray-700">Disclaimer</h3>
                    <p class="text-sm text-gray-600 mt-1">Informational purposes only</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-xl shadow-md p-6 mb-8 border border-blue-100">
            <h2 class="text-xl font-semibold text-gray-800 mb-6 flex items-center">
                <i class="fas fa-gavel text-blue-500 mr-2"></i> Terms of Use
            </h2>
            ...
            <div class="mb-6 p-5 border-l-4 border-blue-500 bg-blue-50 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-800 text-lg">1. Acceptance of Terms</h3>
                        <p class="text-gray-600 mt-2">By accessing and using this website, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use.</p>
                        <ul class="text-gray-600 mt-2 ml-4 list-disc">
                            <li>You must be at least 18 years old to use this site</li>
                            <li>These terms constitute a legal agreement</li>
            ...
            <div class="mb-6 p-5 border-l-4 border-green-500 bg-green-50 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-800 text-lg">2. Informational Purpose Only</h3>
                        <p class="text-gray-600 mt-2">The content on this website is for informational purposes only and does not constitute investment advice or an offer to sell securities.</p>
                        <ul class="text-gray-600 mt-2 ml-4 list-disc">
                            <li>Not investment advice or recommendations</li>
                            <li>Past performance does not guarantee future results</li>
                            <li>Consult qualified professionals for investment advice</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 p-5 border-l-4 border-purple-500 bg-purple-50 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-800 text-lg">3. Intellectual Property</h3>
                        <p class="text-gray-600 mt-2">All content on this website, including text, graphics, logos, and images, is the property of Asset Performance Fund and protected by copyright laws.</p>
                        <ul class="text-gray-600 mt-2 ml-4 list-disc">
                            <li>Content may not be reproduced without permission</li>
                            <li>All trademarks and logos are proprietary</li>
            ...
            <div class="mb-6 p-5 border-l-4 border-yellow-500 bg-yellow-50 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-800 text-lg">4. Prohibited Uses</h3>
                        <p class="text-gray-600 mt-2">You may not use this website for any unlawful purpose or in any way that could damage, disable, or impair the website.</p>
                        <ul class="text-gray-600 mt-2 ml-4 list-disc">
                            <li>No unauthorized access attempts</li>
                            <li>No distribution of malicious software</li>
                            <li>No scraping or automated data collection</li>
            ...
            <!-- Term 5 -->
            <div class="mb-6 p-5 border-l-4 border-red-500 bg-red-50 rounded-lg">
                <div class="flex items-start">
                    <div class="bg-red-100 p-3 rounded-full mr-4">
                        <i class="fas fa-exclamation-circle text-red-600"></i>
                    </div>
                    <div>
                        <h3 class="font-semibold text-gray-800 text-lg">5. Disclaimer of Warranties</h3>
                        <p class="text-gray-600 mt-2">This website is provided "as is" without any representations or warranties, express or implied.</p>
                        <ul class="text-gray-600 mt-2 ml-4 list-disc">
                            <li>We do not guarantee uninterrupted access</li>
                            <li>Content may contain inaccuracies</li>
                            <li>We disclaim all warranties to the fullest extent</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <!-- Term 6 -->
            <div class="p-5 border-l-4 border-indigo-500 bg-indigo-50 rounded-lg">
                <div class="flex items-start">
                    <div class="bg-indigo-100 p-3 rounded-full mr-4">
                        <i class="fas fa-balance-scale text-indigo-600"></i>
                    </div>
                    <div>
                        <h3 class="font-semibold text-gray-800 text-lg">6. Limitation of Liability</h3>
                        <p class="text-gray-600 mt-2">Asset Performance Fund shall not be liable for any damages arising from the use or inability to use this website.</p>
                        <ul class="text-gray-600 mt-2 ml-4 list-disc">
                            <li>No liability for direct or indirect damages</li>
                            <li>No liability for third-party content</li>
        ...
        <section class="bg-white rounded-xl shadow-md p-6 mb-8 border border-blue-100">
            <h2 class="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <i class="fas fa-user-check text-blue-500 mr-2"></i> User Responsibilities
            </h2>
            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <p class="text-gray-600 mb-3">As a user of our website, you agree to:</p>
        ...
        <section class="bg-white rounded-xl shadow-md p-6 mb-8 border border-blue-100">
            <h2 class="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                <i class="fas fa-balance-scale-left text-blue-500 mr-2"></i> Governing Law & Jurisdiction
            </h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
                    <h3 class="font-semibold text-gray-700 mb-2 flex items-center">
                        <i class="fas fa-landmark text-indigo-600 mr-2"></i> Governing Law
                    </h3>
                    <p class="text-gray-600 text-sm">These Terms of Use shall be governed by and construed in accordance with the laws of the State of Arizona, without regard to its conflict of law provisions.</p>
                </div>
                <div class="bg-teal-50 p-4 rounded-lg border border-teal-200">
                    <h3 class="font-semibold text-gray-700 mb-2 flex items-center">
                        <i class="fas fa-gavel text-teal-600 mr-2"></i> Dispute Resolution
                    </h3>
                    <p class="text-gray-600 text-sm">Any disputes arising from these terms shall be resolved through binding arbitration in Mesa, Arizona, in accordance with the rules of the American Arbitration Association.</p>
                </div>
            </div>
        </section>
        ...
        {{-- <section class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl shadow-lg p-6 text-white">
            <h2 class="text-xl font-semibold mb-4 flex items-center">
                <i class="fas fa-sync-alt mr-2"></i> Updates & Contact
            </h2>
            <p class="mb-4">We reserve the right to modify these Terms of Use at any time. Continued use of the website after changes constitutes acceptance of the modified terms.</p>
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="mailto:legal@assetperformancefund.com" class="bg-white text-blue-600 hover:bg-blue-50 font-medium py-2 px-4 rounded-lg text-center transition duration-300">
                    <i class="fas fa-envelope mr-2"></i> legal@assetperformancefund.com
                </a>
        ...
        <footer class="text-center text-gray-500 text-sm mt-8">
            ...
            <p class="mt-2">These Terms of Use were last updated in October 2023 and may be amended periodically.</p>
        </footer>
    </div>
</div>
